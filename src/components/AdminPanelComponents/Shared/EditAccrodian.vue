      ...
      <div class="accordion-content">
        ...
        <div class="option-group">
          <input
            type="text"
            class="option-input"
            v-model="question.option.option_one"
            readonly
          />
          <input
            type="Checkbox"
            :checked="question.correct_ans == 0 ? true : false"
            disabled
          />
        ...
        <div class="option-group">
          <input
            ...
            class="option-input"
            v-model="question.option.option_two"
            readonly
          />
          <input
            type="Checkbox"
            :checked="question.correct_ans == 1 ? true : false"
            disabled
          />
          <label for="">Correct</label>
        </div>
        <div class="option-group">
          <input
            ...
            class="option-input"
            v-model="question.option.option_three"
            readonly
          />
          <input
            type="Checkbox"
            :checked="question.correct_ans == 2 ? true : false"
            disabled
          />
          <label for="">Correct</label>
        </div>
        <div class="option-group">
          <input
            ...
            class="option-input"
            v-model="question.option.option_four"
            readonly
          />
          <input
            type="Checkbox"
            :checked="question.correct_ans == 3 ? true : false"
            disabled
          />
          <label for="">Correct</label>
        </div>
        <div class="accordian-footer"></div>
      </div>
    </div>
  </div>
</template>
