<template>
  <div class="question-body">
      ...
      <div class="option-group">
        <div class="options">
          <div
            ...
            @click="setResult(0)"
          >
            <div>{{ questionData.question.option.option_one }}</div>
            <svg
              v-if="isCorrect[0]"
          ...
          <div
            ...
            @click="setResult(1)"
          >
            <div>{{ questionData.question.option.option_two }}</div>
            <svg
              v-if="isCorrect[1]"
              xmlns="http://www.w3.org/2000/svg"
              width="18"
        ...
        <div class="options">
          <div
            ...
            @click="setResult(2)"
          >
            <div>{{ questionData.question.option.option_three }}</div>
            <svg
              v-if="isCorrect[2]"
              xmlns="http://www.w3.org/2000/svg"
              width="18"
          ...
          <div
            ...
            @click="setResult(3)"
          >
            <div>{{ questionData.question.option.option_four }}</div>
            <svg
              v-if="isCorrect[3]"
              xmlns="http://www.w3.org/2000/svg"
              width="18"
    ...
    <!-- <div class="result" v-if="isResult">
      <div v-if="isCorrectAns" class="correct_ans">Great! Correct Answer.</div>
      <div v-else class="wrong_ans">Wrong Answer!</div>
    </div> -->
  </div>
</template>
...
export default {
  ...
  methods: {
    setResult(id) {
      ...
      const correct = this.questionData.question.correct_ans;
      if (id == correct) {
        this.isResult = true;
