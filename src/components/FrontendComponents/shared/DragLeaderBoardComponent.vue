<template>
  <div class="leaderboard-master">
    ...
    <div class="leader-board-container">
      <div class="popup-primary-header">Drag n Match</div>
      ...
      <div class="popup-footer-content">
        ...
        <a :href="newLink" target="_blank">Shop Now</a>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    fetchLeaderboard(id) {
      ...
      axios
        .post(
          wpApiSettings.root + "custom/v1/get-all-drag-leaderboard-sorted-data",
          data,
          {
            headers: {
