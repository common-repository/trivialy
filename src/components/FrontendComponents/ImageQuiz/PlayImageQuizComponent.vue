<template>
  <div class="question-body">
    ...
    <div class="question-content">
      <img
        :src="baseImgUrl + questionData.image.slice(7)"
        alt=""
        width="210"
        height="130"
      />
      ...
      <div class="option-group">
        <div class="options">
          <div
            ...
            @click="setResult(0)"
          >
            <div>{{ questionData.option_one }}</div>
            <svg
              v-if="isCorrect[0]"
          ...
          <div
            ...
            @click="setResult(1)"
          >
            <div>{{ questionData.option_two }}</div>
            <svg
              v-if="isCorrect[1]"
              xmlns="http://www.w3.org/2000/svg"
              width="18"
        ...
        <div class="options">
          <div
            ...
            @click="setResult(2)"
          >
            <div>{{ questionData.option_three }}</div>
            <svg
              v-if="isCorrect[2]"
              xmlns="http://www.w3.org/2000/svg"
              width="18"
          ...
          <div
            ...
            @click="setResult(3)"
          >
            <div>{{ questionData.option_four }}</div>
            <svg
              v-if="isCorrect[3]"
              xmlns="http://www.w3.org/2000/svg"
              width="18"
