...
import Result from "./ImageQuizResultComponent.vue";
import Play from "./PlayImageQuizComponent.vue";
export default {
  props: {
    imageQuizId: Number,
  },
  ...
  methods: {
    ...
    fetchQuestionData(data) {
      ...
      axios
        .post(this.baseUrl + "sort_image_quiz", sortingAttribute)
        .then((response) => {
    ...
    enableNext(data) {
      // console.log(data);
      this.totalCurrentAns = data.correctAns;
